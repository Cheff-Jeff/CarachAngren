...
<head>
    ...
    <link rel="stylesheet" href="/Recources/CSS/pages/ie.min.css">
    ...
    <meta name="description" content="This browser is no longer supported">
...
<body>
    <div class="main-content">
        <div class="browsers-wrapper">
            ...
            <p>This browser is no longer supported by carach-angren.nl Update your browser for optimal use of carach-angren.nl</p>
            <ul class="browsers">
                <li>
